...
const translations = {
  EN: {
    ...
    title: "Edit Class",
    subtitle: "Update the class name, level and academic year.",
  ...
  FR: {
    ...
    subtitle: "Modifier le nom de la classe, le niveau et l’année scolaire.",
  ...
  AR: {
    ...
    title: "تعديل القسم",
    subtitle: "تعديل اسم القسم، المستوى والسنة الدراسية.",

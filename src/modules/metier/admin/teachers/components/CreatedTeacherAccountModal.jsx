...
export default function CreatedTeacherAccountModal({
  account,
  onClose,
}) {
  ...
  const username =
    account.username ||
    t("createdTeacherAccount.notProvided");
  ...
  const copyCredentials = async () => {
    const credentials = [
      `${t("createdTeacherAccount.username")} : ${username}`,
      `${t(
    ...
    try {
      ...
      console.error(
        t("createdTeacherAccount.copyError"),
        error
      );
    }
  };
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="created-teacher-account-title"
      dir={direction}
      ...
      >
          ...
          <div className="flex min-w-0 items-center gap-4">
            ...
            <div className="min-w-0">
              <p className="text-xs font-bold text-blue-200">
                {t("createdTeacherAccount.section")}
              </p>

              <h2
                id="created-teacher-account-title"
                className="mt-1 text-xl font-black sm:text-2xl"
              >
                {t("createdTeacherAccount.title")}
              </h2>

              <p className="mt-1 text-xs text-slate-300 sm:text-sm">
                {t("createdTeacherAccount.subtitle")}
              </p>
            </div>
          </div>
        ...
        <div className="space-y-5 p-6 sm:p-7">
          ...
          >
            ...
            <div>
              <p className="text-sm font-black text-emerald-500">
                {t("createdTeacherAccount.accountCreated")}
              </p>
              ...
              >
                {t(
                  "createdTeacherAccount.secureCommunication"
                )}
              </p>
            </div>
          </div>
          ...
          <CredentialField
            ...
            label={t("createdTeacherAccount.username")}
            value={username}
            notProvided={t(
              "createdTeacherAccount.notProvided"
            )}
          />
            ...
            >
              ...
              <button
                ...
                title={
                  showPassword
                    ? t(
                        "createdTeacherAccount.hidePassword"
                      )
                    : t(
                        "createdTeacherAccount.showPassword"
                      )
                }
                aria-label={
                  showPassword
          ...
          <div className="flex items-start gap-3 rounded-2xl border border-amber-500/40 bg-amber-500/10 px-4 py-3 text-amber-600 dark:text-amber-300">
            ...
            <p className="text-sm font-semibold">
              {t("createdTeacherAccount.warning")}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-3 pt-1 sm:grid-cols-2">
            ...
            >
              ...
              {copied
                ? t("createdTeacherAccount.copied")
                : t("createdTeacherAccount.copy")}
            </button>

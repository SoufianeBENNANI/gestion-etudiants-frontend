                        ...
                        <>
                          {displayedNotifications.map((notification, index) => (
                            <button
                              ...
                              className={`mb-3 flex w-full gap-3 rounded-2xl border p-3 text-left transition hover:-translate-y-0.5 hover:shadow-md ${notification.read ? "opacity-60" : "opacity-100"
                                }`}
                              style={sectionStyle}
                            >
                              <div
                                className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-white ${notification.read ? "bg-slate-400" : "bg-blue-600"
                                  }`}
                              >
                                {isGmailNotification(notification) ? (
                              ...
                              <div className="min-w-0 flex-1">
                                <p
                                  className={`whitespace-normal break-words text-sm leading-6 ${notification.read ? "font-semibold" : "font-black"
                                    }`}
                                  style={textStyle}
                                >

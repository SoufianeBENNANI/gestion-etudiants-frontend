...
const translations = {
  EN: {
    ...
    title: "Add",
    subtitle: "Add a new student grade.",
    student: "Student",
  ...
  FR: {
    ...
    title: "Ajouter",
    subtitle: "Ajouter une nouvelle note d’étudiant.",
    student: "Étudiant",
  ...
  AR: {
    ...
    title: "إضافة",
    subtitle: "إضافة نقطة جديدة للطالب.",
    student: "الطالب",
...
export default function AddGrade({ open, onClose, onSaved }) {

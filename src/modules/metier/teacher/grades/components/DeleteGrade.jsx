...
const translations = {
  EN: {
    ...
    question: "Are you sure you want to delete this grade?",
    description: "This grade will be archived and removed from the active list.",
    delete: "Delete",
    deleting: "Deleting...",
    close: "Close",
    student: "Student",
  ...
  FR: {
    ...
    question: "Êtes-vous sûr de vouloir supprimer cette note ?",
    description: "Cette note sera archivée et retirée de la liste active.",
    delete: "Supprimer",
  ...
  AR: {
    ...
    question: "هل أنت متأكد أنك تريد حذف هذه النقطة؟",
    description: "سيتم أرشفة هذه النقطة وإزالتها من القائمة النشطة.",
    delete: "حذف",
    deleting: "جاري الحذف...",
    close: "إغلاق",
    student: "الطالب",
...
export default function DeleteGrade({ grade, onClose, onDeleted }) {
          ...
          >
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm font-black">{t.question}</p>
